...
namespace BusinessLayer.Container
{
    public static class Extensions
    {
        ...
        {
            services.AddScoped<IServiceService, ServiceManager>(); // kodu buraya yazdık ki error almayalım
            services.AddScoped<IServiceDal, EfServiceDal>(); // hiyerarşik bir yapıda gidiyor program.cs
